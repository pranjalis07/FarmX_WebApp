<%-- 
    Document   : contracterLogiJSP
    Created on : 25 Feb, 2023, 9:38:31 PM
    Author     : HP
--%>
...
<html>
    ...
    <body>
       <%
            ...
            ResultSet rs=stmt.executeQuery("select username,password,role from ContracterLogins where username='"+uname+"'");
